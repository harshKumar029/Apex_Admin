...
import ViewDetails from './Components/LeadsViewDetails';    // Ensure this component uses `:leadId`
import EditDetails from './Components/LeadsEditDetails';     // Ensure this component uses `:leadId`
import AgentsViewDetails from './Components/AgentsViewDetails'; // Ensure this uses `:agentId`
import AgentsEditDetails from './Components/AgentsEditDetails'; // Ensure this uses `:agentId`
import AgentWithdrawHistory from './Components/AgentWithdrawHistory'; // Ensure this uses `:agentId`
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route
          path="/ManageAgents/ViewManageAgents/:agentId"
          element={
            <ProtectedRoute>
              <AuthLayout>
                <Header title="Manage Agents">
        ...
        />
        <Route
          path="/ManageAgents/EditManageAgents/:agentId"
          element={
            <ProtectedRoute>
              <AuthLayout>
                <Header title="Manage Agents">
        ...
        />
        <Route
          path="/ManageAgents/AgentWithdrawHistory/:agentId"
          element={
            <ProtectedRoute>
              <AuthLayout>
                <Header title="Manage Agents">
